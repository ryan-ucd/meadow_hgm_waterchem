...
#save(m1b,file = "./data_output/models/m1b_revised.rda")
compare(m1a,m2a, m1b)
...
rfWI.2<-rfsrc(mean ~ ., data=rfWI, importance = T)
plot(gg_vimp(rfWI.2, nvar = 10))
plot(gg_minimal_depth(rfWI.2))

rfVI.2<-rfsrc(mean ~ ., data=rfVI, importance = T)
plot(gg_vimp(rfVI.2, nvar = 10))
plot(gg_minimal_depth(rfVI.2))
...
# wyi_s         1.823 0.007
# lat_s         3.154 0.005
# flow_slope_s  3.219 0.005
# shapearea_s   3.575 0.002
# edgecomplex_s 3.881 0.002
# catch_s       3.946 0.003
# elevmean_s    4.184 0.002
# flowrange_s   4.581 0.001
# soilcomp      4.959 0.001
# claytotR_s    5.605 0.001
# sub_s         5.757 0.002
# ----------------------------
