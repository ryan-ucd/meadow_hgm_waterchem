...
```{r ggRandomForest, eval=T, echo=T}
...
plot(gg_vimp(rfWI.2, nvar=10)) + ylab("Variable Importance") #+
  #scale_y_continuous(labels = scales::percent_format(), limits=c(0,1))

plot(gg_vimp(rfVI.2, nvar = 10))+ ylab("Variable Importance")


gg_vi<- gg_variable(rfVI.2)
xvar<- rfVI_md$topvars
plot(gg_vi, xvar=xvar, panel=TRUE, alpha=.4)+labs(y="NDVI", x="")
