...
```{r pull-raw-mdw, include=TRUE, eval=FALSE, echo=TRUE}
...
```{r mdw-merge, include=TRUE, eval=FALSE, echo=TRUE}
...
```{r plot-ndvi-varability, include=TRUE, eval=TRUE, echo=FALSE}
...
```{r plot-ndwi-varability, include=TRUE, eval=TRUE, echo=FALSE}
